...
/**
 * FootPlayerMatchSearch represents the model behind the search form about `common\models\FootPlayerMatch`.
 */
class FootPlayerMatchSearch extends FootPlayerMatch
{
    /**
     * @inheritdoc
     */
